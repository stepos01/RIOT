...
//
//}
/*void static inline assignZero(NN_DIGIT * a, NN_UINT digits)
	{
		uint8_t i;
				for (i = 0; i < digits; i++)
					a[i] = 0;
...
// test whether the ith bit in a is one
  NN_DIGIT TestBit(NN_DIGIT * a, uint16_t i);
//{
 ...
 */
   NN_DIGIT SubDigitMult (NN_DIGIT *a, NN_DIGIT *b, NN_DIGIT c, NN_DIGIT *d, NN_UINT digits);
//{
//	NN_DIGIT borrow;
//	uint16_t i;
//	NN_DOUBLE_DIGIT t;
...
/* Computes a = b + c*d, where c is a digit. Returns carry.
	...
	Lengths: a[digits], b[digits], d[digits].
 */
   NN_DIGIT AddDigitMult (NN_DIGIT *a, NN_DIGIT *b, NN_DIGIT c, NN_DIGIT *d, NN_UINT digits);
//{
//	NN_DIGIT carry;
//	uint16_t i;
//	NN_DOUBLE_DIGIT t;
